...
*
* History    : 1.0B  (2012-06-17)  [Hardware Manual Revision : 1.00]
*            : 1.0C  (2012-11-14)  [Hardware Manual Revision : 1.00]
*            : 2.0   (2014-10-21)  [Hardware Manual Revision : 2.00]
*
...
/*                                                                              */
/********************************************************************************/
#ifndef __RX62GIODEFINE_HEADER__
#define __RX62GIODEFINE_HEADER__
...
struct st_s12ad1 {
	...
	union {
		...
		struct {
			...
			unsigned short CH:2;
			unsigned short :1;
			unsigned short PG102SEL:1;
			unsigned short PG101SEL:1;
			unsigned short PG100SEL:1;
			unsigned short :5;
			unsigned short PG102EN:1;
			unsigned short PG101EN:1;
			unsigned short PG100EN:1;
		} BIT;
	} ADANS;
	char           wk1[4];
	union {
		...
		struct {
			unsigned short :4;
			unsigned short PG102GAIN:4;
			unsigned short PG101GAIN:4;
			unsigned short PG100GAIN:4;
		} BIT;
	} ADPG;
	char           wk2[2];
	union {
...
#define	S12AD1	(*(volatile struct st_s12ad1 __evenaccess *)0x89080)
